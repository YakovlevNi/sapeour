...
public class MinesweeperGame extends Game {
    ...
    private void openTile(int x, int y) {
       ...
       if (gameObject.isOpen && gameObject.isMine==false){
           score+=5;
           setScore(score);
       }
    ...
    private void gameOver() {
        isGameStopped = true;
        showMessageDialog(Color.DARKVIOLET, "Game over", Color.BLACK, 10);
    }

    private void win() {
        isGameStopped = true;
        showMessageDialog(Color.DARKVIOLET, "You win", Color.BLACK, 10);
    }
